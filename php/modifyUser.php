<?php
	...
	if(	empty($LINK) ){
		...
		/*
		THE SYSTEM VERIFY THE CONTENT´S VARIABLES IS CORRECT 
		*/
		
		if( ctype_digit($username) == false ){
		    $DATA["ERROR"] 		= true;
			$DATA["MESSAGE"]	= "ERROR: El rut ingresado contiene letras";
		...
		if( ctype_alpha($name) == false ){
		    $DATA["ERROR"] 		= true;
			$DATA["MESSAGE"]	= "ERROR: El nombre ingresado contiene números";
		...
		if( ctype_alpha($lastname) == false ){
		    $DATA["ERROR"] 		= true;
			$DATA["MESSAGE"]	= "ERROR: El apellido ingresado contiene números";
